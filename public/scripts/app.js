...
function signUp(){
    ...
    if(checkUserFullNameValid == null){
        ...
        firebase.auth().createUserWithEmailAndPassword(userEmail, userPassword).then((success) => {
            ...
            swal('Conta calcService','Sua conta foi criada com sucesso, você pode fazer login agora.',
            ).then((value) => {
                setTimeout(function(){
...
// xxxxxxxxxx Check email or password exsist in firebase authentication xxxxxxxxxx    
    ...
    var inputEmail = document.getElementById('userSIEmail');
    var inputPassword = document.getElementById('userSIPassword');
